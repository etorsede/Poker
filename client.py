...
class Client:
    ...
    def start(self):
        ...
        print()
        print('Welcome, {}! Setting up room...'.format(self.name))
    ...
    def send(self, text_input):
        ...
        imag9 = PIL.Image.open(r"C:\Users\eric9\Desktop\Projekt\Poker\backside.png")
        photo9 = ImageTk.PhotoImage(imag9)

        imag10 = PIL.Image.open(r"C:\Users\eric9\Desktop\Projekt\Poker\outline.png")
        photo10 = ImageTk.PhotoImage(imag10)

        label3 = tk.Label(window, image=photo10)
        label3.place(relx=0.7,
                     rely=0.5)

        label3.config(image=photo9)
        message = 2#text_input.get()
...
def main(host, port):
    ...
    imag2 = PIL.Image.open(r"C:\Users\eric9\Desktop\Projekt\Poker\2.png")
    photo2 = ImageTk.PhotoImage(imag2)

    button2 = tk.Button(window, image=photo2, command=lambda: client.send(text_input))
    button2.pack()
